...
3. I added the 20 Ohm R6 (see the schematic) for better input SWR adaptation (modification suggested by OE1CGS)
...
-	This Board works together with the HL2 and uses SCL2, SDA2 and EXTTR signals from the Rear IO Strip. See how I have connected all these signals to the DB9 in the HL2 to be connected to the DB9 in the Power Amplifer: ([HL2 to PA70 connection](https://github.com/ea3igt/HL2-PA70/blob/main/Images/HL2%20to%20PA70%20connection%20v1.0.JPG))
