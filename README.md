...
- The Bill of Materials to implement the Control Board ([Control Board BOM v2.1](https://github.com/ea3igt/HL2-PA70/tree/main/Control%20Board%20v2.1%20BOM.xlsx))
